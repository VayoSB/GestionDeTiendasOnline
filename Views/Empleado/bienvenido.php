...
<div class="row align-items-start p-2">
  <div class="card ml-4 mr-4" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title"><span class="material-icons align-middle">badge</span>Lista de Empleados</h5>
  ...
  <div class="card mr-4" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title"><span class="material-icons align-middle">business</span>Departamentos</h5>
  ...
  <div class="card mr-4" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title"><span class="material-icons align-middle">inventory</span>Inventario</h5>
  ...
  <div class="card mr-4" style="width: 18rem;">
    <div class="card-body">
      <h5 class="card-title"><span class="material-icons align-middle">people_alt</span>Clientes</h5>
