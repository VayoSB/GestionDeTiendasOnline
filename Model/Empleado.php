...
class Empleado
{
	...
	function __construct($id, $nombre, $apellidos, $direccion, $provincia, $estado)
	{
		$this->setId($id);
	...
	public static function all(){
		...
		foreach($select->fetchAll() as $empleado){
			$listaEmpleados[]=new Empleado($empleado['id'],$empleado['nombre'],$empleado['apellidos'],
				$empleado['direccion'],$empleado['nombre_provincia'],$empleado['estado']);
		}
	...
	//Actualiza los valores de la tabla empleado, a excepción de la provincia
